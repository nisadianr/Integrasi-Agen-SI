...
<head>
    ...
    <title>Sistem Integrasi Agen</title>
</head>
<body class="metro">
    <!--navbar-->
            ...
            <ul class="element-menu">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu dark" data-role="dropdown">
                        <li><a href="akap">Antar Kota Antar Provinsi (AKAP)</a></li>
                        <li class="divider"></li>
                ...
                <li><br><a href="/about">About Us</a></li>
            </ul>
            <br>
            <div class="element place-right"><a href="/login" class="fg-white">Login</a></div>
        </div>
    </div>
    <!--end navbar-->